...
A coordinates plugin for [PGMMV](https://rpgmakerofficial.com/product/act/en/manual/01_01.html).

## Action Commands

### Camera to World

Convert variables from camera to world coordinates.

### World to Camera

Convert variables from world to camera coordinates.
